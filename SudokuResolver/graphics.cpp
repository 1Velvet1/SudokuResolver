...
SDL_INIT_ERROR SDL::initSDL() {
    ...
    for (size_t i = 1; i < 10; i++) {
        ...
        try {
            ...
            MessageBox(GetActiveWindow(), L"где картинки?????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????", L"ЅЋя“№", MB_OK);
...
void SDL::fillGrid(const GRID_POSITION place, const std::vector<std::vector<uint16_t>>& vals) {

    for (size_t i = 1; i < 10; i++) {

        for (size_t j = 1; j < 10; j++) {

            this->drawNumber(place, i, j, vals[i - 1][j - 1]);
